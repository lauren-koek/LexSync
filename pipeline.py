...
def _upsert_document(session, doc: dict, ocr_text: str | None, processed) -> None:
    ...
    if existing is None:
        record = Document(
            ...
            llm_summary_flagged=processed.hallucination_flag if processed else None,
            llm_summary_check_notes=processed.hallucination_notes if processed else None,
            scraped_at=now,
        ...
        if processed is not None:
            ...
            existing.llm_summary_flagged = processed.hallucination_flag
            existing.llm_summary_check_notes = processed.hallucination_notes
